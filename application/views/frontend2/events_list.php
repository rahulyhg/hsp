    ...
    <div id="options" class="clearfix">
      <ul id="filters" class="option-set clearfix" data-option-key="filter">
        ...
        <li><a href="brands_list.php">BRANDS
          ...
          <li><a href="events_list.php" class="selected">EVENTS
          <div class="nav-button"></div>
          </a></li>
  ...
  <div id="content">
    <div class="container">
      <div id="container" class="clearfix">
       <div class="element  clearfix col2-3 home bg centered slider full full-deals">
          <div class="bg-image">
            <div class="flexslider">
              <div class="images">
                <ul class="slides">
                    <li>
                    <img src="images/classes02.jpg" alt=""/>
                    <div class="data">           
                    ...
                    <h2 style="float: left;">Event Name</h2>
                        ...
                        <p class="event-data-adj scrollbox">
                        Phasellus leo ante, posuere in fringilla vitae, pretium at dui. Fusce et neque quis odio gravida auctor vel non mauris. Vivamus gravida aliquet eros. Phasellus leo ante, posuere in fringilla vitae, pretium at dui. Fusce et neque quis odio gravida auctor vel non mauris. Vivamus gravida aliquet eros.
                    ...
                    <li>
                    <img src="images/classes01.jpg" alt=""/>
                    <div class="data">           
                    <div class="info-icon icon_adjust"><i class="icons event"></i>
                    <h2 style="float: left;">Event Name</h2>
                        <div class="soc">
