    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createdinedealsubmit");?>' enctype='multipart/form-data'>
                    <div class="panel-body">
<!--
                        <div class=" form-group">
                            <label class="col-sm-2 control-label" for="normal-field">Dine</label>
                            <div class="col-sm-4">
                                <?php echo form_dropdown( "dine",$dine,set_value( 'dine'), "class='chzn-select form-control'");?>
                            </div>
                        </div>
-->
                    ...
                    <div class="fieldjson"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <a href="<?php echo site_url("site/viewdinedeal?id=").$this->input->get('id'); ?>" class="btn btn-secondary">Cancel</a>
                            </div>
                        </div>
                </form>
                </div>
