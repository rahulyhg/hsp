    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createdinesubmit");?>' enctype='multipart/form-data'>
                    <div class="panel-body">
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php
						...
						echo form_dropdown('categoryfordine[]',$categoryfordine,set_value('categoryfordine'),'id="select3" class="chzn-select form-control" 	data-placeholder="Choose an categoryfordine..." multiple');
					?>
				  </div>
				</div>           
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php
						...
						echo form_dropdown('amenity[]',$amenity,set_value('amenity'),'id="select4" class="chzn-select form-control" 	data-placeholder="Choose an amenity..." multiple');
					?>
				  </div>
				</div>
