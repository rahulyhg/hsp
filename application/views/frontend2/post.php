    ...
    <div class="container">
      <div id="container" class="clearfix">
        ...
        <div class="element clearfix col1-3 home">
          <div class="images"><img src="images/pic02.jpg" alt="" /></div>
        </div>
        <div class="element clearfix col1-3 home">
          <h5>Categories</h5>
...
<footer>
  <ul class="social clearfix alignleft">
    ...
    <li class="skype"><a href="#" onClick="return false">Visit our skype Account</a></li>
  </ul>
  <span class="alignright">© 2014, FitnessPoint</span> <span class="alignright disclaimer"> <a href="#" title="">Disclaimer</a></span> </footer>
<!-- BACK TO TOP BUTTON -->
<div id="backtotop">
  <ul>
