    ...
    <div class="container">
      <div id="container" class="clearfix">
       ...
       <div class="element home clearfix col1-3 half half-img">
              <img src="images/united_banner.jpg" alt="" />
          </div>
          <div class="element home clearfix col1-3">
          <div class="info-icon"><i class="icons cup"></i>
            <h2>About Product</h2>
          </div>
          <div class="scrollbox brand-desc"><p>Phasellus leo ante, posuere in fringilla vitae, pretium at dui. Fusce et neque quis odio gravida auctor vel non mauris. Vivamus gravida aliquet eros. Fusce et neque quis odio gravida auctor vel non mauris. Vivamus gravida aliquet eros. Fusce et neque quis odio gravida auctor vel non mauris. Vivamus gravida aliquet eros. </p></div>
          </div>
         ...
         <div class="element home clearfix col1-3">
          ...
          <div class="infos-right lr">
            <p class="small"> 
                  <a href=""><img src="images/amenity1_w.png" /></a>
                  <a href=""><img src="images/amenity2_w.png" /></a>
            </p>
          </div>
            <div class="soc" style="border-top: 1px solid #000;">
                  <a href="#"><img src="images/facebook.png" /></a> 
                  <a href="#"><img src="images/twitter.png" /></a>
                  <a href="#"><img src="images/pinintrest.png" /></a>
                  <a href="#"><img src="images/youtube.png" /></a>   
                  <a href="#"><img src="images/mail.png" /></a>         
              </div>
        </div>
           <div class="element home clearfix col1-3 full">
              <div class="info-icon icon_adjust"><div class="info-icon"><i class="icons special"></i>
                <h2>Special Offer</h2>
              </div>
                <div class="scrollbox sp-offer">
                    <p>One of the most respected sports brand Adidas offers a wide range of sports footwear for key games such as soccer and cricket. One of the most respected sports brand - Adidas offers a wide range of sports footwear for key games such as soccer and cricket. One of the most respected sports brand Adidas offers a wide range of sports footwear for key games such as soccer and cricket. One of the most respected sports brand - Adidas offers a wide range of sports footwear for key games such as soccer and cricket. One of the most respected sports brand Adidas offers a wide range of sports footwear for key games such as soccer and cricket. One of the most respected sports brand - Adidas offers a wide range of sports footwear for key games such as soccer and cricket. One of the most respected sports brand Adidas offers a wide range of sports footwear for key games such as soccer and cricket. One of the most respected sports brand - Adidas offers a wide range of sports footwear for key games such as soccer and cricket. One of the most respected sports brand Adidas offers a wide range of sports footwear for key games such as soccer and cricket. One of the most respected sports brand - Adidas offers a wide range of sports footwear for key games such as soccer and cricket.</p>
                 </div>
                  <div class="sp-offer-img">
                      <img src="images/united_banner.jpg" class="sp-img" alt="" />
                  </div>
          </div>
    </div>
  </div>
