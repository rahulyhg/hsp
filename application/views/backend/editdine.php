<section class="panel">
    ...
    <div class="panel-body">
        <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editdinesubmit");?>' enctype='multipart/form-data'>
           ...
           <div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php
						...
						echo form_dropdown('categoryfordine[]',$categoryfordine,$selectedcategoryfordine,'id="select3" class="chzn-select form-control" 	data-placeholder="Choose an categoryfordine..." multiple');
					?>
				  </div>
				</div>
           ...
           <div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php
						...
						echo form_dropdown('amenity[]',$amenity,$selectedamenity,'id="select4" class="chzn-select form-control" 	data-placeholder="Choose an amenity..." multiple');
					?>
				  </div>
				</div>
